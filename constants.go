...
var sanct_vrt2 = []int{
	 ...
	 0x80d0,		// 	G2MP_WALL_MOVABLE
	 0x8190,		// 	G2MP_WALL_SECRET
	 0x8210,		// 	G2MP_WALL_DESTRUCTABLE: 5
	 0x81d0,		// 	G2MP_WALL_RANDOM
	 0x404030,		// 	G2MP_WALL_TRAPCYC1
	 0x404031,		// 	G2MP_WALL_TRAPCYC2
	 0x404032,		// 	G2MP_WALL_TRAPCYC3
	 0x80b0,		// 	G2MP_TILE_TRAP1
	 0x80b1,		// 	G2MP_TILE_TRAP2
	 0x80b2,		// 	G2MP_TILE_TRAP3
	 0xc0c000,		// 	G2MP_DOOR_HORIZ
	 0xc0c000,		// 	G2MP_DOOR_VERT
	 0xf000,		// 	G2MP_PLAYERSTART
	 0x4000,		// 	G2MP_EXIT: 16,
	 ...
	 0x400020,		// 	G2MP_MONST_AUX_GRUNT: 23,		// ! sanctuary does not encode aux grunts yet
