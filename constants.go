...
var sanct_vrt = []int{
	 ...
	 0x80e3,		// 	G1OBJ_X_ARMOR: 47,
	 0x80e0,		// 	G1OBJ_X_SPEED: 48,
	 0x80e5,		// 	G1OBJ_X_MAGIC: 49,
	 0x80e1,		// 	G1OBJ_X_SHOTPW: 50,
	 0x80e2,		// 	G1OBJ_X_SHTSPD: 51,
	 0x80e4,		// 	G1OBJ_X_FIGHT: 52,
	 0x8050,		// 	G1MP_KEY: 53,
...
var sanct_vrt2 = []int{
	 ...
	 0xa08060,		// 	MAZEOBJ_TILE_FLOOR: 0,
	 0x80c0,		// 	MAZEOBJ_TILE_STUN: 1,
	 0x404000,		// 	MAZEOBJ_WALL_REGULAR: 2,
	 0x80d0,		// 	MAZEOBJ_WALL_MOVABLE
	 0x8190,		// 	MAZEOBJ_WALL_SECRET
	 0x8210,		// 	MAZEOBJ_WALL_DESTRUCTABLE: 5
	 0x81d0,		// 	MAZEOBJ_WALL_RANDOM
	 0x404030,		// 	MAZEOBJ_WALL_TRAPCYC1
	 0x404031,		// 	MAZEOBJ_WALL_TRAPCYC2
	 0x404032,		// 	MAZEOBJ_WALL_TRAPCYC3
	 0x80b0,		// 	MAZEOBJ_TILE_TRAP1
	 0x80b1,		// 	MAZEOBJ_TILE_TRAP2
	 0x80b2,		// 	MAZEOBJ_TILE_TRAP3
	 0xc0c000,		// 	MAZEOBJ_DOOR_HORIZ
	 0xc0c000,		// 	MAZEOBJ_DOOR_VERT
	 0xf000,		// 	MAZEOBJ_PLAYERSTART
	 0x4000,		// 	MAZEOBJ_EXIT: 16,
	 0x4030,		// 	G1MP_EXIT6: 17,
	 0x400000,		// 	G1MP_MONST_GHOST3: 18,
	 0x400020,		// 	G1MP_MONST_GRUNT3: 19,
	 0x400010,		// 	G1MP_MONST_DEMON3: 20,
	 0x400050,		// 	G1MP_MONST_LOBBER3: 21,
	 0x400030,		// 	G1MP_MONST_SORC3: 22,
	 0x400020,		// 	MAZEOBJ_MONST_AUX_GRUNT: 23,		// ! sanctuary does not encode aux grunts yet
	 0x400040,		// 	G1MP_MONST_DEATH: 24,
	 0x400120,		// 	MAZEOBJ_MONST_ACID: 25,
	 0x400130,		// 	MAZEOBJ_MONST_SUPERSORC: 26,
	 0x400140,		// 	MAZEOBJ_MONST_IT: 27,
	 0xf000b0,		// 	G1MP_GEN_GHOST1: 28,
	 0xf00060,		// 	G1MP_GEN_GHOST2: 29,
	 0xf00000,		// 	G1MP_GEN_GHOST3: 30,
	 0xf000d0,		// 	G1MP_GEN_GRUNT1: 31,
	 0xf00080,		// 	G1MP_GEN_GRUNT2: 32,
	 0xf00020,		// 	G1MP_GEN_GRUNT3: 33,
	 0xf000c0,		// 	G1MP_GEN_DEMON1: 34,
	 0xf00070,		// 	G1MP_GEN_DEMON2: 35,
	 0xf00010,		// 	G1MP_GEN_DEMON3: 36,
	 0xf000f0,		// 	G1MP_GEN_LOBBER1: 37,
	 0xf000a0,		// 	G1MP_GEN_LOBBER2: 38,
	 0xf00050,		// 	G1MP_GEN_LOBBER3: 39,
	 0xf000e0,		// 	G1MP_GEN_SORC1: 40,
	 0xf00090,		// 	G1MP_GEN_SORC2: 41,
	 0xf00030,		// 	G1MP_GEN_SORC3: 42,
	 0xf000d0,		// 	MAZEOBJ_GEN_AUX_GRUNT1: 43,
	 0xf00080,		// 	MAZEOBJ_GEN_AUX_GRUNT2: 44,
	 0xf00020,		// 	MAZEOBJ_GEN_AUX_GRUNT3: 45,
	 0x8070,		// 	G1MP_TREASURE: 46,
	 0x8080,		// 	MAZEOBJ_TREASURE_LOCKED: 47,
	 0x8090,		// 	MAZEOBJ_TREASURE_BAG: 48,
	 0x8000,		// 	G1MP_FOOD_DESTRUCTABLE: 49,
	 0x8020,		// 	G1MP_FOOD_INVULN: 50,
	 0x8060,		// 	G1MP_POT_DESTRUCTABLE: 51,
	 0x8061,		// 	G1MP_POT_INVULN: 52,
	 0x8050,		// 	G1MP_KEY: 53,
	 0x80f0,		// 	MAZEOBJ_POWER_INVIS: 54,
	 0x80f2,		// 	MAZEOBJ_POWER_REPULSE: 55,
	 0x80f3,		// 	MAZEOBJ_POWER_REFLECT: 56,
	 0x80f5,		// 	MAZEOBJ_POWER_TRANSPORT: 57,
	 0x80f4,		// 	MAZEOBJ_POWER_SUPERSHOT: 58,
	 0x80f1,		// 	MAZEOBJ_POWER_INVULN: 59,
	 ...
	 0x000067,		// 	G1MP_nospec_: 67,
	 0x000068,		// 	G1MP_nospec_: 68,
	 0x000069,		// 	G1MP_nospec_: 69,
	 0x80e0,		// 	G1OBJ_X_SPEED: 70,
	 0x80e1,		// 	G1OBJ_X_SHOTPW: 71,
	 0x80e2,		// 	G1OBJ_X_SHTSPD: 72,
	 0x80e3,		// 	G1OBJ_X_ARMOR: 73,
	 0x80e4,		// 	G1OBJ_X_FIGHT: 74,
	 0x80e5,		// 	G1OBJ_X_MAGIC: 75,
	 0x8090,		// 	MAZEOBJ_TREASURE_BAG: 76,
