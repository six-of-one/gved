...
var hsct = []dysb{
	{0,0,"",0,0,0	,0,1,0	,0},
	{6, 10.0,		"WARRIORS",222,10,10	,0,17,8	,0},
}
var hsct2 = []dysb{
	{0,0,"",0,0,0	,0,1,0	,0},
	{6, 10.0,		"ELVES",36,230,46	,0,226,8	,0},
}
