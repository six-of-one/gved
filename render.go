...
//fmt.Printf("g1exit %d x %d, vc: %d x %d\n ",x,y,vcx, vcy)
	...
	case G1OBJ_MONST_DEMON1:
		...
		cnt = 64
		dyn = [100]int{
			6189, 6198, 6207, 6216, 6225, 6279, 6288, 6297, 6306, 6315, 6369, 6378, 6387, 6400, 6409, 6463, 6472, 6481, 6490, 6499, 6508, 6517, 6526, 6535, 6544, 6418, 6427, 6436, 6445, 6454, 6324, 6333, 6342, 6351, 6360, 6234, 6243, 6252, 6261, 6270,
