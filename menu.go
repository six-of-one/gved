...
//	menuItemTmap := fyne.NewMenuItem("Map++ test",func() { map_test() })
	...
	menuFile := fyne.NewMenu("File", menuItemLodf, menuItemSava, menuItemBlan, menuItemBlnK, menuItemWll, menuItemFmap, menuItemFmapb, menuItemFmapc, menuItemFmapd, menuItemRand, menuItemRedwl, menuItemLin1, menuItemMute, menuItemExit)
